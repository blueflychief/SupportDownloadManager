...
public final class DownloadProvider extends ContentProvider {
    ...
    private static final String[] sAppReadableColumnsArray = new String[]{
            ...
            Downloads.COLUMN_CURRENT_BYTES, Downloads.COLUMN_CURRENT_SPEED,
            Downloads.COLUMN_TIME_REMAINING, Downloads.COLUMN_TITLE,
        ...
        private void upgradeTo(SQLiteDatabase db, int version) {
            switch (version) {
                ...
                case 106:
                    ...
                    break;
                case 107:
                    addColumn(db, DB_TABLE, Downloads.COLUMN_CURRENT_SPEED, "INTEGER NOT NULL DEFAULT 0");
                    addColumn(db, DB_TABLE, Downloads.COLUMN_TIME_REMAINING, "INTEGER NOT NULL DEFAULT 0");
                    break;
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        filteredValues.put(Downloads.COLUMN_CURRENT_SPEED, 0);
        copyInteger(Downloads.COLUMN_TIME_REMAINING, values, filteredValues);
