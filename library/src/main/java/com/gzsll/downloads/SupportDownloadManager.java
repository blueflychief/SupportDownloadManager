 ...
 * downloads UI.
 */
public class SupportDownloadManager {
    @SuppressWarnings("unused")
    private static final String TAG = "SupportDownloadManager";
     ...
     * completes.
     */
    public final static String ACTION_DOWNLOAD_COMPLETE = "com.gzsll.downloads.action.DOWNLOAD_COMPLETE";
     ...
     * downloads UI.
     */
    public final static String ACTION_NOTIFICATION_CLICKED = "com.gzsll.downloads.action.DOWNLOAD_NOTIFICATION_CLICKED";

    /**
     * Intent action to launch an activity to display all downloads.
     */
    public final static String ACTION_VIEW_DOWNLOADS = "com.gzsll.downloads.action.VIEW_DOWNLOADS";
    ...
    private static final String[] UNDERLYING_COLUMNS = new String[]{
            ...
            Downloads.COLUMN_STATUS, Downloads.COLUMN_CURRENT_BYTES, Downloads.COLUMN_CURRENT_SPEED,
            Downloads.COLUMN_TIME_REMAINING,
    ...
    protected SupportDownloadManager() {
    }
     ...
     * defined in the SupportDownloadManager.COLUMN_* constants. Some columns
