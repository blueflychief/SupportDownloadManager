...
/**
 * List adapter for Cursors returned by {@link SupportDownloadManager}.
 */
public class DownloadAdapter extends CursorAdapter {
    ...
    public DownloadAdapter(Context context, Cursor cursor,
        ...
        mIdColumnId = cursor.getColumnIndexOrThrow(SupportDownloadManager.COLUMN_ID);
        mTitleColumnId = cursor
                .getColumnIndexOrThrow(SupportDownloadManager.COLUMN_TITLE);
        ...
        mTotalBytesColumnId = cursor
                .getColumnIndexOrThrow(SupportDownloadManager.COLUMN_TOTAL_SIZE_BYTES);
        mCurrentBytesColumnId = cursor
                .getColumnIndexOrThrow(SupportDownloadManager.COLUMN_BYTES_DOWNLOADED_SO_FAR);
        mMediaTypeColumnId = cursor
                .getColumnIndexOrThrow(SupportDownloadManager.COLUMN_MEDIA_TYPE);
        mDateColumnId = cursor
                .getColumnIndexOrThrow(SupportDownloadManager.COLUMN_LAST_MODIFIED_TIMESTAMP);
    }
    ...
    public void bindView(View convertView) {
        ...
        if (status == SupportDownloadManager.STATUS_FAILED
                || status == SupportDownloadManager.STATUS_SUCCESSFUL) {
